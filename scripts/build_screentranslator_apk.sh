...
APP_DIR="$SRC_DIR/unica/apps/screentranslator"
OUT_APK="$SRC_DIR/unica/mods/v_screentranslator/system/priv-app/UnicaScreenTranslator/UnicaScreenTranslator.apk"
