...
#
# Builds the UnicaDownloader priv-app APK and drops the signed binary into the
# mediadownloader ROM mod so apply_modules.sh can pick it up.
#
...
APP_DIR="$SRC_DIR/unica/apps/mediadownloader"
OUT_APK="$SRC_DIR/unica/mods/videodownloader/system/priv-app/UnicaDownloader/UnicaDownloader.apk"
GRADLE_VERSION="8.9"
