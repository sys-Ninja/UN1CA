...
if [ ! -f "$MODPATH/system/priv-app/UnicaGhostEngine/UnicaGhostEngine.apk" ]; then
    LOGE "UnicaGhostEngine.apk not found at $MODPATH/system/priv-app/UnicaGhostEngine/"
    LOGE "Run ./scripts/build_ghostengine_apk.sh and retry."
    return 1
fi
