...
if [ ! -f "$MODPATH/system/priv-app/UnicaSecretSpace/UnicaSecretSpace.apk" ]; then
    LOGE "UnicaSecretSpace.apk not found at $MODPATH/system/priv-app/UnicaSecretSpace/"
    LOGE "Run ./scripts/build_secretspace_apk.sh and retry."
    return 1
fi
