...
if [ ! -f "$MODPATH/system/priv-app/UnicaScreenTranslator/UnicaScreenTranslator.apk" ]; then
    LOGE "UnicaScreenTranslator.apk not found at $MODPATH/system/priv-app/UnicaScreenTranslator/"
    LOGE "Run ./scripts/build_screentranslator_apk.sh and retry."
    return 1
fi
